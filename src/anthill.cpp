...
void CAntHill::print ( CScreen * scr )
{
  ...
  // mvwprintw( scr -> m_Window, m_Coords . m_Y + 3, m_Coords . m_X, "%d", m_Attack );
  // mvwprintw( scr -> m_Window, m_Coords . m_Y + 3, m_Coords . m_X+1, "%d", m_Armor );
  // mvwprintw( scr -> m_Window, m_Coords . m_Y + 3, m_Coords . m_X+3, "%d", m_Armor );
  // mvwprintw( scr -> m_Window, m_Coords . m_Y + 3, m_Coords . m_X+4, "%d", m_Max );
  // mvwprintw( scr -> m_Window, m_Coords . m_Y + 3, m_Coords . m_X+6, "%d", m_Move );
  wattroff( scr -> m_Window, COLOR_PAIR ( c ) );
}